...
int main(int argc, const char * argv[]) {
    ...
    do {
        ...
        if (healthinfo.status == RPLIDAR_STATUS_ERROR) {
            fprintf(stderr, "Error, rplidar_wrapper internal error detected. Please reboot the device to retry.\n");
            // enable the following code if you want rplidar_wrapper to be reboot by software
            // drv->reset();
            break;
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////
        if (IS_FAIL(drv->startScan( 0,1 ))) // you can force rplidar_wrapper to perform scan operation regardless whether the motor is rotating
        {
